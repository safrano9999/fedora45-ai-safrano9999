...
for name in AI_CORE_PRE_IMAGE FEDORA45_AI_CORE_IMAGE OPENCLAW_VERSION OPENCLAW_UPSTREAM_SHA OPENCLAW_DETERMINISTIC_TAG NOTE_REPOSITORY \
...
BUILD_ARGS=(
    ...
    --build-arg "OPENCLAW_UPSTREAM_SHA=$OPENCLAW_UPSTREAM_SHA"
    --build-arg "OPENCLAW_DETERMINISTIC_TAG=$OPENCLAW_DETERMINISTIC_TAG"
